export const IconAdd = () => {
  return (
    <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 512 512" title="Создание сайта">
      <path d="M257,0C116.39,0,0,114.39,0,255s116.39,257,257,257s255-116.39,255-257S397.61,0,257,0z M392,285H287v107
			...
			c0-16.54,13.46-30,30-30c16.53,0,30,13.46,30,30v105h105c16.53,0,30,13.46,30,30S408.53,285,392,285z"  fill="#16D090" />
    </svg>
  )
}